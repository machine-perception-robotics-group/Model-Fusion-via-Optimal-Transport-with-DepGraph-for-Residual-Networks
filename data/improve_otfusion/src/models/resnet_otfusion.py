...
# Taken from https://github.com/sidak/otfusion
...
def ResNet18(num_classes=10, use_batchnorm=True, linear_bias=True):
    return ResNet(
        BasicBlock, [2, 2, 2, 2], num_classes=num_classes, use_batchnorm=use_batchnorm, linear_bias=linear_bias
    )


def ResNet34(num_classes=10, use_batchnorm=True, linear_bias=True):
    return ResNet(
        BasicBlock, [3, 4, 6, 3], num_classes=num_classes, use_batchnorm=use_batchnorm, linear_bias=linear_bias
    )


def ResNet50(num_classes=10, use_batchnorm=True, linear_bias=True):
    return ResNet(
        Bottleneck, [3, 4, 6, 3], num_classes=num_classes, use_batchnorm=use_batchnorm, linear_bias=linear_bias
    )


def ResNet101(num_classes=10, use_batchnorm=True, linear_bias=True):
    return ResNet(
        Bottleneck, [3, 4, 23, 3], num_classes=num_classes, use_batchnorm=use_batchnorm, linear_bias=linear_bias
    )


def ResNet152(num_classes=10, use_batchnorm=True, linear_bias=True):
    return ResNet(
        Bottleneck, [3, 8, 36, 3], num_classes=num_classes, use_batchnorm=use_batchnorm, linear_bias=linear_bias
    )
